...
<!-- Optional JavaScript -->
    ...
    <div class="header">
        ...
        <div class="nav_bar">
            <a href="http://dalrov.local/" style="text-decoration: none">Home</a>
            <a href="http://dalrov.local/about/"style="text-decoration: none">About</a>
            <a href="http://dalrov.local/team/"style="text-decoration: none">Team</a>
